...
public class ResearchInteractionFixture {
	...
	@Inject
	public ResearchInteractionFixture(TopNavFixture topNavFixture, MyTestEnvironment testEnv) {
	...
	public void verify_the_search_results_for_content(String contentType) {
		...
		if(contentType.equalsIgnoreCase("fees")){
			...
			//Assert.assertTrue("Comprendre les frais de transaction étrangères is not present",pegaDriver.verifyElement(By.xpath("//span/a[text()='Comprendre les frais de transaction étrangères']")));
		}
