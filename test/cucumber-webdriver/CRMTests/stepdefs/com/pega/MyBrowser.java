...
public class MyBrowser extends com.pega.cs.BrowserImpl {
	...
	public void user_navigates_to_the_Manager_tools() throws Throwable {
		/*
		 * PegaWebElement managerTools =
		 * pegaDriver.findElement(By.xpath("//a[@title='Manager tools']"));
		 * managerTools.click();
		 */
	}
	...
	public void user_navigates_to_Dashboard() {
		/*
		 * PegaWebElement myWork =
		 * pegaDriver.findElement(By.xpath("//a[@title='My work']")); myWork.click();
		 * PegaWebElement dashboard =
		 * pegaDriver.findElement(By.xpath("//a[@title='Dashboard']"));
