...
public class MyBrowser extends com.pega.cs.BrowserImpl{
	...
	public void verify_Operator_name(String username) throws Throwable {
		...
		{
			String FinalXpath = "//div[@class='content-item content-field item-1 remove-all-spacing   dataValueWrite flex flex-row ']/i[@title='"+username+"']";
	...
	public void user_navigates_to_the_Manager_tools() throws Throwable {
		/*PegaWebElement managerTools = pegaDriver.findElement(By.xpath("//a[@title='Manager tools']"));
		managerTools.click();*/
	}
	...
	public void user_navigates_to_Dashboard() {
		/*PegaWebElement myWork = pegaDriver.findElement(By.xpath("//a[@title='My work']"));
		myWork.click();
		PegaWebElement dashboard = pegaDriver.findElement(By.xpath("//a[@title='Dashboard']"));
		dashboard.click(false);*/
	}
	...
	@When("^Operator logs of the chat portal$")
	public void operator_logs_of_the_chat_portal() throws Throwable {
		chatUserLogout();
	}
	...
	@When("^Cancel the Interaction$")
	public void cancel_the_Interaction() throws Throwable {
	...
	@When("^change the call volume to \"([^\"]*)\"$")
	public void change_the_call_volume_to(String arg1) {
		changeVolumeAlert(arg1);
	}


	@Given("^Navigate to WSS Portal with App Name \"([^\"]*)\"$")
	public void navigate_to_WSS_Portal_with_App_Name(String appName) {
		wssPortal = getPortal(WSSPortal.class);
		wssPortal.loginByShortUrl(appName);
	...
	public void verify_the_top_Nav_links_for_sys_admin() {
		...
		pegaDriver.verifyElement(By.
				xpath("//div[@class ='content-item content-field item-3    current-application with-icon dataValueWrite flex flex-row ']/span/a[@title='Application menu']"));
		pegaDriver.verifyElement(By.
				xpath("//div[@class ='content-item content-field item-4    launch-portals with-icon dataValueWrite flex flex-row ']/span/a[@title='Launch another portal']"));
		pegaDriver.verifyElement(By.
				xpath("//div[@class ='content-item content-field item-5 remove-right-spacing    create-case with-icon dataValueWrite flex flex-row ']/span/a[@title='Create a case']"));
	...
	public void log_of_the_portal_as_operator() {
		logoutasManager();
	...
	public void verify_the_top_Nav_links() {
		...
		pegaDriver.verifyElement(By.xpath("//div[@class='field-item dataValueWrite']/img[contains(@title,'Dan Percival')]"));
		pegaDriver.switchTo().defaultContent();
	}
	...
	public void operator_logs_off_automation_portal() throws Throwable {
		logoffAutomationPortal();
	...
	public void click_submit_to_share_the_article(){
		/*Currently error message is displayed when clicking on send, hence changing the code to CANCEL flow*/
		shareArticle();
	...
	public void filter_with_Account_number_Type_Status_and_owner(String AcNo, String Type, String Status, String OwnerName){
	...
	public void filter_with_Org_name_Type_Tax_ID_Ind_Cntry_City_state(String Name, String Type, String TaxID, String Industry, String Country, String City, String State){
	...
	public void filter_with_FN_Ln_Org_phone_mail_city_State(String Fname, String Lname, String mail, String City, String State) {
	...
	public void filter_with_article_Content_Average_Content(String article, String Content, String Average, String Views) {
	...
	public void close_the_interaction_case() {
		...
		pegaDriver.switchToActiveFrame();
		PegaWebElement closeInteraction = pegaDriver.findElement(By.xpath("//a[@class='Wrap_up' and @title='Close item']"));
	...
	public void filter_with_Case_Id_description_AcNo_CustName_and_Status(String desc, String AcNo, String CName, String Status) {
...
String CAMPAIGN_LIST_XPATH= "//span[text()='Campaign']";
	...
	public void select_Level_for_start_of_Interaction() throws Throwable {
	    ...
	    pegaDriver.switchTo().frame("PegaGadget0Ifr");
	    //pegaDriver.switchTo().frame("PegaGadget0Ifr");
	    DropDown levelForStartInteraction = pegaDriver.findSelectBox(By.xpath("//select[@data-test-id='201806020309450738246185']"));
	...
	public void delete_and_add_service_cases_with_interaction_level(DataTable servicecases) throws Throwable {
		...
		List<WebElement> rows = pegaDriver.findElements(By.xpath("//table[@pl_prop_class='PegaCS-Data-CasesVerification']/tbody/tr"));
		System.out.println(rows.size() + "is ss sss");
     for (int k = rows.size(); k >= 2; k--) {
    	 pegaDriver.switchTo().defaultContent();
 		pegaDriver.switchTo().frame("pxExpress");
 		pegaDriver.switchTo().frame("PegaGadget0Ifr");
    if (pegaDriver.verifyElement(By.xpath("//table[@pl_prop_class='PegaCS-Data-CasesVerification']/tbody/tr[@id='Grid_NoResults']"))) {
System.out.println("Inside loop no results");
} else {
PegaWebElement delticn = pegaDriver.findElement(By.xpath("//table[@pl_prop_class='PegaCS-Data-CasesVerification']/tbody/tr["+ k + "]/td[3]/div/span/a"));
delticn.click();
}
     }
		...
		//{
			...
			pegaDriver.switchTo().frame("pxExpress");
			pegaDriver.switchTo().frame("PegaGadget0Ifr");
			PegaWebElement serviceCases = pegaDriver.findElement(By.xpath("(//input[@data-test-id='2016072109335505834280'])["+i+"]"));
	...
	public void select_number_of_fields_contact_fields_and_customer_security_fields_in_Customer_verification_screen() throws Throwable {
          ...
          // TODO Auto-generated method stub
				...
				pegaDriver.switchTo().frame("PegaGadget0Ifr");	
                        ...
                        for(List<String> row:listOfFields){
                              ...
                              if(!chbk1.isSelected()){chbk1.click();}
                              //pegaDriver.switchToActiveFrame();
                              pegaDriver.switchTo().defaultContent();
                        	  pegaDriver.switchTo().frame("pxExpress");
                        	  pegaDriver.switchTo().frame("PegaGadget0Ifr");
	...
	pegaDriver.switchTo().frame("pxExpress");
	pegaDriver.switchTo().frame("PegaGadget0Ifr");	
	List<WebElement> sourceFields = driver.findElements(By.xpath("//select[@data-test-id='201805170737380328342600']"));
	...
	for(int i=1;i<=sourceFields.size();i++)
	{
		...
		pegaDriver.switchTo().frame("pxExpress");
		pegaDriver.switchTo().frame("PegaGadget0Ifr");
		DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("(//select[@data-test-id='201805170737380328342600'])["+i+"]"));
	...
	public void select_fields_for_Account_source(DataTable Fields) throws Throwable {
		...
		pegaDriver.switchTo().frame("pxExpress");
		pegaDriver.switchTo().frame("PegaGadget0Ifr");	
		List<WebElement> fields = driver.findElements(By.xpath("//select[@data-test-id='201805171007370954171870']"));
		...
		//{
			...
			//System.out.println("The value of j before Increment"+j);
                  //pegaDriver.switchToActiveFrame();
			DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("(//select[@data-test-id='201805171007370954171870'])["+i+"]"));
	...
	*/
	...
	public void select_source_category(DataTable sourcecategory) throws Throwable {
		...
		List<WebElement> rows = pegaDriver.findElements(By.xpath("//table[@pl_prop_class='PegaCS-Data-FieldsVerification']/tbody/tr"));
		System.out.println(rows.size() + "is ss sss");
     for (int k = rows.size(); k >= 2; k--) {
    	 pegaDriver.switchTo().defaultContent();
 		pegaDriver.switchTo().frame("pxExpress");
 		pegaDriver.switchTo().frame("PegaGadget0Ifr");
    if (pegaDriver.verifyElement(By.xpath("//table[@pl_prop_class='PegaCS-Data-FieldsVerification']/tbody/tr[@id='Grid_NoResults']"))) {
System.out.println("Inside loop no results");
} else {
PegaWebElement delticn = pegaDriver.findElement(By.xpath("//table[@pl_prop_class='PegaCS-Data-FieldsVerification']/tbody/tr["+ k + "]/td[6]/div/span/a"));
delticn.click();
}
     }
		...
		//{
			...
			pegaDriver.switchTo().frame("pxExpress");
			pegaDriver.switchTo().frame("PegaGadget0Ifr");
			DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("(//select[@data-test-id='2016072109335505834280'])["+i+"]"));
		    minNumberFields.selectByValue(""+row.get(0)+"");
		    i=i+1;
		    //j=j+1;
		    System.out.println("The value of i after Increment"+i);
	...
	public void select_fields_for_Account_source(DataTable Fields) throws Throwable {
		...
		for(List<String> row:listOfFields){
			...
			pegaDriver.switchTo().frame("PegaGadget0Ifr");
                  //pegaDriver.switchToActiveFrame();
			DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("(//select[@data-test-id='201806080226100176632890'])["+i+"]"));
	...
	public void enter_fields_in_Text_for_CSR(DataTable textfields) throws Throwable {
		...
		for(List<String> row:listOfFields){
			...
			pegaDriver.switchTo().frame("PegaGadget0Ifr");
                  //pegaDriver.switchToActiveFrame();
			PegaWebElement textFields = pegaDriver.findElement(By.xpath("(//input[@data-test-id='201806080226100176630370'])["+i+"]"));
	...
	public void select_Apply_for_Account_source_fields() throws Throwable {
		...
		for(int i=1;i<=fields.size();i++)
		{
			...
			pegaDriver.switchTo().frame("PegaGadget0Ifr");
                  //pegaDriver.switchToActiveFrame();
			DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("(//select[@data-test-id='201806080226100177631878'])["+i+"]"));
	...
	public void select_level_of_interaction_for_all_cases() throws Throwable {
		...
		for(int i=1;i<=fields.size();i++)
		{
			...
			pegaDriver.switchTo().frame("PegaGadget0Ifr");
                  //pegaDriver.switchToActiveFrame();
			DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("(//select[@data-test-id='20180516023216098750179'])["+i+"]"));
		    minNumberFields.selectByIndex(2); 
	...
	public void select_score_for_Account_source_fields() throws Throwable {
		...
		for(int i=0;i<fields.size();i++)
		{
			...
			pegaDriver.switchTo().frame("PegaGadget0Ifr");
                  //pegaDriver.switchToActiveFrame();
			//DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("(//input[@data-test-id='20180514094632023767885'])["+i+"]"));
	...
	public void select_Apply_to_for_Account_source_fields(DataTable applyTo) throws Throwable {
		...
		while(itr.hasNext()){
            ...
            for(List<String> row:listOfFields){
                  pegaDriver.switchToActiveFrame();
			DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("//select[contains(@name,'VerificationAppliesTo')]"));
		    minNumberFields.selectByValue(""+row.get(0)+"");
		 	itr.next(); 
		}
		}
	...
	public void select_score_for_Account_fields(DataTable score) throws Throwable {
		...
		while(itr.hasNext()){
            ...
            for(List<String> row:listOfFields){
                  pegaDriver.switchToActiveFrame();
			DropDown minNumberFields = pegaDriver.findSelectBox(By.xpath("//select[contains(@name,'VerificationScore')]"));
		    minNumberFields.selectByValue(""+row.get(0)+"");
		 	itr.next(); 
		}
		}
    ...
    public void validate_account_datasource_selected_fields_displayed_in_search_section() throws Throwable {
          ...
          pegaDriver.switchToActiveFrame();
                 ...
                 Assert.assertTrue("Status is not present",
                               pegaDriver.verifyElement(By.xpath("//div[text()='Status']")));
...
/*	@After("@Smoke")
	...
	public void update_threshold_to_mins(String threshold) {
		pegaDriver.switchTo().defaultContent();
		pegaDriver.switchToActiveFrame();
		PegaWebElement thresholdElement = pegaDriver.findElement(By.xpath("//input[@data-test-id='20180202043413020554654']"));
	...
	public void select_maximum_no_of_fields_to_display_and_min_no_of_fields_to_verify_for_CSR() throws Throwable {
	    ...
	    maxNumberFieldsVerify.selectByValue("5");
	 	//DropDown maxNumberFieldsVerify1 = pegaDriver.findSelectBox(By.id("MaximumFieldsToDisplay"));
	...
	public void select_Required_checkbox_for_Account_sources() throws Throwable {
		...
		List<WebElement> checkBox = driver.findElements(By.xpath("//input[@type='checkbox' and @data-test-id='20180514094743033970194']"));
		for(int i=1;i<=checkBox.size();i++)
		{
			pegaDriver.switchTo().defaultContent();
		    pegaDriver.switchTo().frame("pxExpress");
		    pegaDriver.switchTo().frame("PegaGadget0Ifr");
			PegaWebElement requiredCheckBox = pegaDriver.findElement(By.xpath("(//input[@type='checkbox' and @data-test-id='20180514094743033970194'])["+i+"]"));
	...
	public void select_Use_for_Owner_checkbox_for_Account_source() throws Throwable {
		...
		List<WebElement> checkBox = driver.findElements(By.xpath("//input[@type='checkbox' and @data-test-id='201805150257300490224783']"));
		for(int i=1;i<=checkBox.size();i++)
		{
			pegaDriver.switchTo().defaultContent();
		    pegaDriver.switchTo().frame("pxExpress");
		    pegaDriver.switchTo().frame("PegaGadget0Ifr");
			PegaWebElement requiredCheckBox = pegaDriver.findElement(By.xpath("(//input[@type='checkbox' and @data-test-id='201805150257300490224783'])["+i+"]"));
			if(!requiredCheckBox.isSelected())
			{requiredCheckBox.click();
			}
			//requiredCheckBox.click();
...
public void select_include_security_questions_checkbox() throws Throwable {
    ...
    pegaDriver.switchTo().frame("pxExpress");
    pegaDriver.switchTo().frame("PegaGadget0Ifr");
	PegaWebElement managesecurityquescheckbox = pegaDriver.findElement(By.xpath("//input[contains(@name,'SecurityQuestionsSelected') and @type='checkbox']"));
...
public void user_logs_off_from_designer_studio() throws Throwable {
	...
	PegaWebElement logoff = pegaDriver.findElement(By.xpath("//i[contains(@class,'icons avatar name') and @data-test-id='px-opr-image-ctrl']"));
	logoff.click(false);
	//pegaDriver.switchTo().defaultContent();
    //pegaDriver.switchTo().frame("FormFactoriFrame");
    //pegaDriver.switchTo().frame("PegaGadget0Ifr");
