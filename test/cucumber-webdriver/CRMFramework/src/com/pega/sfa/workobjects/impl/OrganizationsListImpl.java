...
public class OrganizationsListImpl extends WizardImpl implements OrganizationsList{
	...
	public OrganizationsListImpl(WebElement elmt) {
		super(elmt);
	}
	
	public OrganizationsListImpl(WebElement elmt, String elmtId){
		super(elmt, elmtId);
	}
	...
	public OrganizationsList searchOrganization(String orgName) {
		...
		PegaWebElement framElmt = pegaDriver.findElement(By.id(frameId));
		pegaDriver.switchTo().frame(frameId);
		OrganizationsList org = new OrganizationsListImpl(framElmt, frameId);
		org._setEnvironment(testEnv, frameId);
		return org;
	...
	public Organization openFirstOrganization() {
		...
		Organization organization = new OrganizationImpl(framElmt, frameId);
