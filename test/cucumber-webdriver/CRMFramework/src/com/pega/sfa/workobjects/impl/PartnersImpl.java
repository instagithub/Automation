...
public class PartnersImpl extends WizardImpl implements Partners {
	...
	public PartnersImpl(WebElement elmt, String elmtId) 
	{
		super(elmt, elmtId);
	}
	...
	public void setWebSite(String WebSite) {
		...
		pegaDriver.findElement(By.id(WEBSITE_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setPhone(String Phone) {
		pegaDriver.waitForDocStateReady(1);
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(PHONE_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setPartnerName(String Partner) {
		//pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(PATNER_NAME_ID)).sendKeys(UtilImpl.SelectAll);
		//pegaDriver.getActiveFrameId(true);
	...
	public void setPartnerID(String PartnerID) {
		pegaDriver.waitForDocStateReady(1);
		//pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(PARTNER_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setPartnerTaxID(String TaxID) {
		pegaDriver.waitForDocStateReady(1);
		//pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(PARTNER_TAXID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setPartnerWorkFax(String WorkFax) {
		...
		pegaDriver.getActiveFrameId(true);*/
		pegaDriver.waitForDocStateReady(1);
		pegaDriver.findElement(By.id(PARTNER_WORKFAX)).sendKeys(UtilImpl.SelectAll);
	...
	public void setEmail(String Email)
	{
		pegaDriver.waitForDocStateReady(1);
		//pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(EMAIL_ID)).sendKeys(UtilImpl.SelectAll);
...
*/		//pegaDriver.findElement(By.id(SFA_ACCESS_TYPE_ID)).sendKeys((Keys.SPACE));
	...
	{
		pegaDriver.waitForDocStateReady(1);
		UtilImpl.autoComplete(pegaDriver, TERRITORY_FIELD_ID, TerritoryName);
	...
	public void setOwner(String OwnerName) {
		pegaDriver.getActiveFrameId(true);
		UtilImpl.autoComplete(pegaDriver, TERRITORY_OWNER_ID, OwnerName);
		
	}

	@Override
	public void setParentTerritory(String ParentTerritory) {
		UtilImpl.autoComplete(pegaDriver, PARENT_TERRITORY_ID, ParentTerritory);
	...
	public void clickOperatorsSubtab() {
		UtilImpl.getSubTab(pegaDriver, "Operators");
