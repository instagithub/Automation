...
public class LeadsImpl extends WizardImpl implements Leads
{
	
	String LEAD_SUBTABS_XPATH = "//div[@role='tab']//h2";

	public LeadsImpl(WebElement elmt, String elmtId) {
		super(elmt, elmtId);
	...
	{
		pegaDriver.findElement(By.id(LEAD_COMPANY_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setTerritory(String str) {
		pegaDriver.getActiveFrameId(true);
		UtilImpl.autoComplete(pegaDriver,LEAD_TERRIOTRY_ID, str);
	...
	public void closeLead() {
		...
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.xpath(UtilImpl.OPP_NEXTYEAR_XPATH)).click();
		pegaDriver.getActiveFrameId(true);
	...
	{
		pegaDriver.getActiveFrameId(true);
		UtilImpl.dropdown(pegaDriver, UtilImpl.ACTION_BUTTON_XPATH, "Clone lead");
	...
	public void setWorkPhone(String WorkPhone) {
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(LEAD_WORK_PHONE_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setEmail(String Email) {
		...
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(LEAD_EMAIL_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setLeadFirstName(String FirstName) {
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(LEAD_FIRSTNAME)).sendKeys(UtilImpl.SelectAll);
	...
	public void setLeadMobile(String Mobile) {
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(LEAD_MOBILE)).sendKeys(UtilImpl.SelectAll);
	...
	public void setLeadDesc(String Desc) {
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(LEAD_DESC)).sendKeys(UtilImpl.SelectAll);
...
@Override
	...
	public void setOwner(String LEAD_UPDATEDOWNER) {
		...
		pegaDriver.getActiveFrameId(true);
		*/
		pegaDriver.findElement(By.id(LEAD_CHANGEOWNER_ID)).sendKeys(UtilImpl.SelectAll);
		UtilImpl.autoComplete(pegaDriver, LEAD_CHANGEOWNER_ID, LEAD_UPDATEDOWNER);
	...
	public List<String> getTaskValues(String LeadName) {
		...
		return(UtilImpl.getRowValues(pegaDriver, LEAD_TASK_ROW_IDENTIFIER_XPATH, LeadName));
	}
	...
	public List<String> getActivityValues(String ActivityName) {
		...
		return(UtilImpl.getRowValues(pegaDriver, LEAD_ACTIVITY_ROW_IDENTIFIER_XPATH, ActivityName));
	}
	...
	public void setContact(String ContactName) {
		...
		UtilImpl.autoComplete(pegaDriver, LEAD_CONTACT_ID, ContactName);
