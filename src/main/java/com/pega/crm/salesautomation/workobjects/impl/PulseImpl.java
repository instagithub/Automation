...
public class PulseImpl extends WizardImpl implements Pulse{
	...
	String PULSE_POST_BUTTON_XPATH=UtilImpl.getButtonXpath("Post");
	String PULSE_FIRST_POST_XPATH="(//div[@data-node-id='pyPostDetails']//div[@class='pulse-display-post'])[1]";
	public PulseImpl(WebElement elmt, String elmtId) {
		super(elmt, elmtId);
