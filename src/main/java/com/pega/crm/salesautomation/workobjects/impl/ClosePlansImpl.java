...
public class ClosePlansImpl extends WizardImpl implements ClosePlans{

	String FILTERBY_ID="BaseFilterForLP";
	String APPLYBUTTON_XPATH=UtilImpl.getButtonXpath("Apply");
	String EXPORTBUTTON_XPATH=UtilImpl.getButtonXpath("Export");
	...
	String ADDNEW_XPATH=UtilImpl.getStrongButtonXPath("Add new");
	public ClosePlansImpl(WebElement elmt, String elmtId) {
		super(elmt, elmtId);
	}
