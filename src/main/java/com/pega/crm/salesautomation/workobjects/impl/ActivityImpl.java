...
public class ActivityImpl extends WizardImpl implements Activity{
	...
	String ACTIVITY_CREATE_XPATH=UtilImpl.getStrongButtonXPath("Create");
	By AddExistingContacts = By.xpath("//*[@data-test-id='201412050548470928176275']");

	public String ContactSearchTerm = "crmSearchTerm";
			
	public ActivityImpl(WebElement elmt) {
		super(elmt);
		// TODO Auto-generated constructor stub
	} 
	
	public ActivityImpl(WebElement elmt, String elmtId){
		super(elmt, elmtId);
	}
	...
	public void addExistingContacts(String contactName) {
		...
		UtilImpl.autoComplete(pegaDriver,ContactSearchTerm, contactName);
	...
	public void addActivityTasks(String TaskSub, String DueDate,String AssignedTo, String TaskType) {
		...
		*/
		...
		pegaDriver.getActiveFrameId(true);
		UtilImpl.autoComplete(pegaDriver, "AssignedTo1", AssignedTo);
