...
public class PegaAppointment extends WizardImpl implements Appointment{
	...
	public void clickAddInternalStaff(String s) {
		...
		pegaDriver.waitForDocStateReady(2);
		PegaUtil.autoComplete(pegaDriver, APP_STAFF_ID, s);
	}
	...
	public void clickAddContacts(String s) {
		...
		pegaDriver.waitForDocStateReady(1);
		PegaUtil.autoComplete(pegaDriver, APP_CONTACT_ID, s);
		pegaDriver.waitForDocStateReady(1);
	}
	...
	public void updateLocation(String updatedlocation) {
		...
		pegaDriver.findElement((APP_LOCATION_ID)).sendKeys(PegaUtil.SelectAll);
