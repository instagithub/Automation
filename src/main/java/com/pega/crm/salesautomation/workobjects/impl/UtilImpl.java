...
public  class UtilImpl
{
	...
	public static String SUBMIT_XPATH="//button[@id='ModalButtonSubmit']"+"|"+ XPathUtil.getButtonPzBtnMidXPath("Submit") + "|" + UtilImpl.getStrongButtonXPath("Submit");
	...
	public static String ACTION_BUTTON_XPATH=UtilImpl.getButtonXpath("Actions");
	...
	public static String ACC_EDIT_XPATH=UtilImpl.getButtonXpath("Edit");
	public static String CREATE_XPATH=UtilImpl.getStrongButtonXPath("Create");
	public static String DISCARD_XPATH=UtilImpl.getSimpleButtonXPath("Discard");
	...
	public static String REFRESH_XPATH=UtilImpl.getButtonXpath("Refresh") + "|//i[@alt='Refresh']|//i[@title='Refresh']";
...
*/
	...
	public static String OPP_CONTACT_REFRESH_XPATH="//button[contains(@name,'crmOpportunityContactsTab')][text()='Refresh']" +"|"+ UtilImpl.getButtonXpathWithIcon("Refresh")+"|"+"//i[contains(@name, 'contacts')][contains(@class,'refresh')]";
  ...
  public static void openRowWithDoubleClick(PegaWebDriver pegaDriver, String RowIdentifier, String ColumnIdentifier, String RowValue)
	...
	public static Tasks addTask(PegaWebDriver pegaDriver) {
		pegaDriver.getActiveFrameId(true);
		UtilImpl.dropdown(pegaDriver, UtilImpl.ACTION_BUTTON_XPATH, "Add task");
		String frameId = pegaDriver.getActiveFrameId(false);
