...
public abstract class DialogsAndCoachingTipsImpl extends WizardImpl implements DialogsAndCoachingTips {
	...
	public DialogsAndCoachingTipsImpl(WebElement elmt, String frameId) {
		super(elmt, frameId);
		commonMethods = new CommonMethods(pegaDriver);
	}

	public DialogsAndCoachingTipsImpl(WebElement elmt) {
		super(elmt);
	}
