...
public interface RuleInstance extends Frame {
	...
	static By ISSUE_SELECT_BOX = By.xpath("//select[@id='IssueClass']|//select[@id='Issue']|//select[@id='pyIssue']|//select[@data-test-id='201505151039200044666168']");
	static By GROUP_SELECT_BOX = By.xpath("//select[@id='GroupClass']|//select[@id='Group']|//select[@id='pyGroup']|//select[@data-test-id='201505151039200045667317']");
