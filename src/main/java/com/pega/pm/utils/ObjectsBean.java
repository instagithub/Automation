...
import com.pega.pm.pages.UnsubscribedCustomers.SubscriptionReportDrillDown;
...
import com.pega.pm.pages.PaidMediaAudiences;
...
public class ObjectsBean {
	...
	private static com.pega.pm.rules.Designer.ConfigureBussinessIssuesDialog configBussIssue;
	...
	public static void setConfigBussinessIssueDialog(
			com.pega.pm.rules.Designer.ConfigureBussinessIssuesDialog configBussIssue) {
		ObjectsBean.configBussIssue = configBussIssue;
	}

	public static com.pega.pm.rules.Designer.ConfigureBussinessIssuesDialog getConfigBussinessIssuesDialog() {
