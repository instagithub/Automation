...
public class OpportunityImpl extends WizardImpl implements Opportunity {

	String OPP_SERACHBUTTON_XPATH=UtilImpl.getButtonXpath("Search");
	...
	String OPP_CHANGE_STAGE_XPATH=UtilImpl.getButtonXpath("Change stage");
	...
	String OPP_CREATE_XPATH=UtilImpl.getStrongButtonXPath("Create");
	...
	String OPP_NEXT_BUTTON_XPATH=UtilImpl.getStrongButtonXPath("Next");
	...
	String OPP_UNFOLLOW_XPATH=UtilImpl.getButtonXpath("Unfollow");
	String OPP_FOLLOW_XPATH=UtilImpl.getButtonXpath("Follow");
	...
	public OpportunityImpl(WebElement elmt, String elmtId) 
	{
		super(elmt, elmtId);
	...
	public void setAmount(String oppAmount) {
		...
		pegaDriver.findElement(By.id(OPP_AMOUNT_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setDate() 
	{
		UtilImpl.setDate(pegaDriver, OPP_CALANDER_XPATH);
	}
	...
	{
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(OPP_NAME_ID)).sendKeys(UtilImpl.SelectAll);
	...
	public void setTerritory(String oppTerritory) {
		...
		UtilImpl.autoComplete(pegaDriver, OPP_TERRITORY_ID, oppTerritory);
	}

	@Override
	public void setContact(String oppContact) {
		UtilImpl.autoComplete(pegaDriver, OPP_CONTACT_ID, oppContact);
	...
	public void setOwner(String changeOwner) {
		...
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(OPP_CHANGEOWNER_ID)).sendKeys(UtilImpl.SelectAll);
		UtilImpl.autoComplete(pegaDriver, OPP_CHANGEOWNER_ID, changeOwner);
	...
	public void clickUpdateStage() {
		UtilImpl.dropdown(pegaDriver, UtilImpl.ACTION_BUTTON_XPATH, "Change stage");
	}
	...
	public void clickCloneOpportunity() {
		pegaDriver.getActiveFrameId(true);
		UtilImpl.dropdown(pegaDriver, UtilImpl.ACTION_BUTTON_XPATH, "Clone opportunity");
	...
	public void setDueDate() {
		UtilImpl.setDate(pegaDriver, OPP_DUEDATE_XPATH);
	...
	{
		pegaDriver.getActiveFrameId(true);
		UtilImpl.dropdown(pegaDriver, UtilImpl.ACTION_BUTTON_XPATH, "Update contacts");
	...
	public void enterContact(String contactName)
	{
		...
		UtilImpl.autoComplete(pegaDriver, OPP_SEARCH_CONTACT_ID, contactName);
	}
	...
	public void clickCloseplanSubtab() 
	{
		...
		pegaDriver.getActiveFrameId(true);
		UtilImpl.getSubTab(pegaDriver, "Close plans");
	...
	{
		pegaDriver.getActiveFrameId(true);
		UtilImpl.dropdown(pegaDriver, UtilImpl.ACTION_BUTTON_XPATH, "Merge opportunity");
	...
	public void navigateToRecentOppty(String cloneopptyname) {
		UtilImpl.navigateToRecentItem(pegaDriver, cloneopptyname);
	...
	public List<String> getTaskValues(String RowName) {
		...
		return(UtilImpl.getRowValues(pegaDriver, OPP_TASK_ROW_IDENTIFIER_XPATH, RowName));
	...
	public List<String> getActivityValues(String ActivityName) {
		Wizard wizard=pegaDriver.findWizard(pegaDriver.getActiveFrameId(false));
		wizard.findElement(By.xpath(UtilImpl.ACTIVITY_REFRESH_XPATH)).scrollIntoView();
		//pegaDriver.findElement(By.xpath()).scrollIntoView();
		pegaDriver.findElement(By.xpath(UtilImpl.ACTIVITY_REFRESH_XPATH)).click();
		
		return(UtilImpl.getRowValues(pegaDriver, OPP_ACTIVITY_ROW_IDENTIFIER_XPATH, ActivityName));
	}
...
@Override
	...
	public void clearAccountinMergeOppty() {
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(OPP_CONTACT_ID)).sendKeys(UtilImpl.SelectAll);
	}
	...
	public void clearOwnerinMergeOppty() {
		pegaDriver.getActiveFrameId(true);
		pegaDriver.findElement(By.id(OPP_CLEARCHANGEOWNER_ID)).sendKeys(UtilImpl.SelectAll);
	}
	...
	public void addTeamMember(String operator) {
		...
		UtilImpl.autoComplete(pegaDriver, OPP_SEARCH_CONTACT_ID, operator);
		pegaDriver.getActiveFrameId(true);
