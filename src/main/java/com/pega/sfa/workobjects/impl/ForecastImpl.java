...
public class ForecastImpl extends WizardImpl implements Forecast{
	...
	String FILTERBUTTON_XPATH=UtilImpl.getButtonXpath("Filter");
	...
	public ForecastImpl(WebElement elmt, String elmtId) {
		super(elmt, elmtId);
	...
	public void setTerritory(String Territory) {
		pegaDriver.findElement(By.id(TERRITORY_ID)).sendKeys(UtilImpl.SelectAll);
		UtilImpl.autoComplete(pegaDriver, TERRITORY_ID, Territory);
