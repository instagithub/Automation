...
Feature: PegaMarketing Selenium Shippable Tests
  ...
  Scenario: Create Basic Criteria Segment
    ...
    And Adds a group and criteria as "SegmentCriteria" and value as "M"
    ...
    And End of the run, Population count should become "2,570"
  ...
  Scenario: Create an Email Offer Flow
   ...
   Scenario: Creation of Strategy from Strategy Designer page
    ...
    And User enters strategy name and description as "DemoStrategy"
